...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url('employee_crud/update');?>" method="POST">
            ...
            <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo $emp['full_name']?>">
            </div>
            <div class="col">
            <label for="name">Email</label>
            <input type="text" class="form-control" id="email" name="email" value="<?php echo $emp['email']?>">
            </div>
        </div>
        ...
        <div class="row pb-3">
            ...
            <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $emp['mobile_no']?>">
            </div>
            <div class="col">
            <label for="name">City</label>
            <input type="text" class="form-control" id="city" name="city" value="<?php echo $emp['city']?>">
            </div>
        </div>            
